    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'c8c3431c235c4f3da82f2b2f5e5ceb4e',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_839752217659');
                if (frame) {
...
;np764531("c8c3431c235c4f3da82f2b2f5e5ceb4e",false);


try{__tagObject_callback_839752217659({ImpressionID:"c8c3431c235c4f3da82f2b2f5e5ceb4e", ServerPublicDns:"tps616.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "c8c3431c235c4f3da82f2b2f5e5ceb4e");}catch(e){}
try{__verify_callback_839752217659({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "c8c3431c235c4f3da82f2b2f5e5ceb4e");}catch(e){}
