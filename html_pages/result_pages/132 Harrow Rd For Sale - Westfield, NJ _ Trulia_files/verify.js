    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'a985aa0026bd4d95bcf03327c903d514',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_7654357798');
                if (frame) {
...
;np764531("a985aa0026bd4d95bcf03327c903d514",false);


try{__tagObject_callback_7654357798({ImpressionID:"a985aa0026bd4d95bcf03327c903d514", ServerPublicDns:"tps613.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "a985aa0026bd4d95bcf03327c903d514");}catch(e){}
try{__verify_callback_7654357798({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "a985aa0026bd4d95bcf03327c903d514");}catch(e){}
