    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'50db4c744df249f081a76ecb0ab6d83c',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_899238286839');
                if (frame) {
...
;np764531("50db4c744df249f081a76ecb0ab6d83c",false);


try{__tagObject_callback_899238286839({ImpressionID:"50db4c744df249f081a76ecb0ab6d83c", ServerPublicDns:"tps603.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "50db4c744df249f081a76ecb0ab6d83c");}catch(e){}
try{__verify_callback_899238286839({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "50db4c744df249f081a76ecb0ab6d83c");}catch(e){}
