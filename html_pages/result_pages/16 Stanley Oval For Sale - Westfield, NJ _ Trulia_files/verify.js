    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'02f97410db044047ba6d02f81a49180f',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_261401752665');
                if (frame) {
...
;np764531("02f97410db044047ba6d02f81a49180f",false);


try{__tagObject_callback_261401752665({ImpressionID:"02f97410db044047ba6d02f81a49180f", ServerPublicDns:"tps603.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "02f97410db044047ba6d02f81a49180f");}catch(e){}
try{__verify_callback_261401752665({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "02f97410db044047ba6d02f81a49180f");}catch(e){}
